  ...
  return (
    <>
      ...
      <div className="z-20 relative w-full h-screen overflow-hidden heroSection" >
        ...
        <img src='/AboutHero2-img.avif' className='hidden lg:block top-0 left-0 absolute w-full h-full object-cover'  />
        <img src='/AboutHeroMobile-img.avif' className='lg:hidden block top-0 left-0 absolute w-full h-full object-cover' />
